  ...
  return (
    <Page meta={meta}>
      <Layout>
        ...
        <p>Inspired by a <a href='https://twitter.com/KitMerker/status/1359874708800294912'>twitter conversation</a> on the elevation of customer experience and happiness between engineers and product managers, the SLOConf, the Service Level Objective Conference for Site Reliability Engineers is a community-led event. The opportunity to share, educate, and learn about SLOs, builds on the success of the Beyond Seattle SRE Meetup . Engineers, practitioners, and interested parties from mid-market and enterprise companies around the globe are expected to attend.</p>
        <h2>Talks</h2>
        <p>This event will have four tracks focused on everything you want to learn about SLOs. <a href="/tracks">Learn more</a></p>
        <h2>Labs</h2>
        <p>SLOConf will also bring you hands-on labs built to learn more about SLOs. <a href='/labs'>Learn more</a></p>
        <h2>What to expect</h2>
        <p>As a community-led SLOConf, attendees can participate throughout their day based on what they want to learn and engage on. Expect minimal synchronous communication. Also, we take learning seriously, so <strong>there is a strict no sales pitch policy</strong>.<br />Join in the SLOConf with:</p>
        <ul>
        ...
        <p>Follow @SLOConf on <a href='https://twitter.com/sloconf'>Twitter</a>.</p>
      </Layout>
    </Page >
  );
}
